  ...
  return (
		<section className="w-screen h-auto pb-20 bg-[#FAF5F1]">
			<div className="w-full relative h-auto flex justify-start pt-10">
				<h1 className="z-20 whitespace-nowrap font-cabinet relative font-bold text-9xl ml-20 mt-20 text-[#AD3520]">
			...
			<span className="w-screen h-auto flex justify-center mt-48">
				<p className="z-20 font-bold font-cabinet text-3xl text-center text-[#AD3520] w-[40%]">
			...
			<span className="w-screen h-auto flex justify-center mt-20">
				<details>
					<summary className="list-none font-cabinet font-bold text-5xl cursor-pointer text-[#FAF5F1] py-5 px-3 bg-[#AD3520] flex items-center justify-center">
					...
					<div className="mt-4">
						{services.map((service, index) => (
							<div
								key={index}
								className="border-b border-gray-300 pb-4 mb-4 last:border-none last:mb-0"
							>
